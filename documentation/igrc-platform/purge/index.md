...
The criteria definition for timeslots having existing workflow is done the same way as for standard timeslot criteria, beginning with the selection of workflow type:  
